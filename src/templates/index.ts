...
import type {
  BuilderEditFormContext,
  RadioFormContext,
  RadioHTMLContext,
  SelectContext,
  SelectHTMLContext,
  SelectOptionContext,
  SelectOptionHTMLContext,
  ...
  TreeViewContext,
  WizardFormContext,
  WizardHeaderClassicFormContext,
  WizardHeaderFormContext,
} from "../types/contexts";

// Define the type for cssClasses to include an index signature
...
// Define the type for the templates object
...
// Export the template with proper typing
export default goforms as unknown as Templates;
