...
((__t = ( cssClasses['form-pdf-builder-upload'] )) == null ? '' : __t) +
'">\n  <h3 class="' +
...
((__t = ( cssClasses['form-pdf-builder-upload-dropzone'] )) == null ? '' : __t) +
'" ref="fileDrop">\n    <span ref="dragDropText">\n      <i class="' +
((__t = (ctx.iconClass('cloud-upload'))) == null ? '' : __t) +
'"></i>' +
((__t = (ctx.t('dropToStart'))) == null ? '' : __t) +
' <a href="#" ref="fileBrowse" class="' +
((__t = ( cssClasses['form-pdf-builder-upload-browse'] )) == null ? '' : __t) +
'">' +
((__t = (ctx.t('browse'))) == null ? '' : __t) +
'</a>\n    </span>\n    <div class="' +
((__t = ( cssClasses['form-pdf-builder-upload-progress'] )) == null ? '' : __t) +
'" ref="uploadProgressWrapper" style="display:none;">\n      <div class="' +
((__t = ( cssClasses['form-pdf-builder-upload-progress-bar'] )) == null ? '' : __t) +
