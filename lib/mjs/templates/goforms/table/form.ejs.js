...
((__t = ( cssClasses['form-table'] )) == null ? '' : __t) +
'\n    ' +
...
'\n  ">\n  <caption class="' +
((__t = ( cssClasses['form-table-caption'] )) == null ? '' : __t) +
'">' +
((__t = (ctx.t(ctx.component.label))) == null ? '' : __t) +
'</caption>\n  ';
 if (ctx.component.header && ctx.component.header.length > 0) { ;
__p += '\n  <thead class="' +
((__t = ( cssClasses['form-table-header'] )) == null ? '' : __t) +
'">\n    <tr class="' +
((__t = ( cssClasses['form-table-row'] )) == null ? '' : __t) +
'">\n      ';
 ctx.component.header.forEach(function(header) { ;
__p += '\n      <th class="' +
((__t = ( cssClasses['form-table-header-cell'] )) == null ? '' : __t) +
'" scope="col">' +
...
__p += '\n  <tbody class="' +
((__t = ( cssClasses['form-table-body'] )) == null ? '' : __t) +
'">\n    ';
...
__p += '\n      <td class="' +
((__t = ( cssClasses['form-table-cell'] )) == null ? '' : __t);
