...
((__t = ( cssClasses['form-dialog'] )) == null ? '' : __t) +
'">\n  <div class="' +
((__t = ( cssClasses['form-dialog-overlay'] )) == null ? '' : __t) +
'" ref="dialogOverlay"></div>\n  <div class="' +
((__t = ( cssClasses['form-dialog-content'] )) == null ? '' : __t) +
'" ref="dialogContents" role="dialog">\n    <div ref="dialogContents"></div>\n    <button class="' +
((__t = ( cssClasses['form-dialog-close'] )) == null ? '' : __t) +
