...
'">\n  <ul class="' +
((__t = ( cssClasses['form-wizard-navigation'] )) == null ? '' : __t) +
'">\n    ';
 ctx.panels.forEach(function(panel, index) { ;
__p += '\n    <li class="' +
((__t = ( cssClasses['form-wizard-navigation-item'] )) == null ? '' : __t) +
' ' +
((__t = (ctx.currentPage === index ? ' ' + cssClasses['form-wizard-navigation-item-active'] : '')) == null ? '' : __t) +
'">\n      <span class="' +
((__t = ( cssClasses['form-wizard-navigation-link'] )) == null ? '' : __t) +
'" ref="' +
((__t = (ctx.wizardKey)) == null ? '' : __t) +
'-link">\n        ' +
...
((__t = (ctx.wizardKey)) == null ? '' : __t) +
'-tooltip" class="' +
((__t = ( cssClasses['form-wizard-navigation-tooltip'] )) == null ? '' : __t) +
'" data-tooltip="' +
