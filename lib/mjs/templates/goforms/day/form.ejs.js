...
((__t = ( cssClasses['form-day'] )) == null ? '' : __t) +
'" role="group"\n  ';
...
__p += '\n  <div class="' +
((__t = ( cssClasses['form-day-field'] )) == null ? '' : __t) +
'">\n    ';
 if (!ctx.component.hideInputLabels) { ;
__p += '\n    <label for="' +
((__t = (ctx.component.key)) == null ? '' : __t) +
'-day" class="' +
((__t = ( cssClasses['form-day-label'] )) == null ? '' : __t) +
' ';
 if(ctx.component.fields.day.required) { ;
__p +=
((__t = ( cssClasses['form-day-required'] )) == null ? '' : __t);
 } ;
__p += '">' +
...
__p += '\n    <div class="' +
((__t = ( cssClasses['form-day-input'] )) == null ? '' : __t) +
'">' +
...
((__t = ( cssClasses['form-day-hidden'] )) == null ? '' : __t) +
