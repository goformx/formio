...
__p += '<div class="' +
((__t = ( ctx.cssClasses['form-panel'] )) == null ? '' : __t) +
'">\n  ';
 if (!ctx.label.hidden || ctx.builder || ctx.component.collapsible || ctx.component.tooltip) { ;
__p += '\n  <div class="' +
((__t = ( ctx.cssClasses['form-panel-header'] )) == null ? '' : __t) +
' ' +
...
'"\n    ref="header"\n  >\n    <span class="' +
((__t = ( ctx.cssClasses['form-panel-title'] )) == null ? '' : __t) +
'">\n      ';
 if (ctx.component.collapsible) { ;
__p += '\n        <i class="' +
((__t = ( ctx.cssClasses['form-icon'] )) == null ? '' : __t) +
' ' +
...
((__t = ( ctx.cssClasses['form-label-tooltip'] )) == null ? '' : __t) +
' ' +
...
__p += '\n  <div class="' +
((__t = ( ctx.cssClasses['form-panel-body'] )) == null ? '' : __t) +
'" ref="' +
