...
__p += '<% const cssClasses = require(\'../cssClasses\'); %>\n';
 if (ctx.options.vpat) { ;
__p += '\n  <span tabindex="-1" class="<%= cssClasses[\'form-file-hidden\'] %>" id="invisible-' +
...
__p += '\n  <ul class="<%= cssClasses[\'form-file-list\'] %>">\n    <li class="<%= cssClasses[\'form-file-header\'] %>">\n      <div class="<%= cssClasses[\'form-file-row\'] %>">\n        <div class="<%= cssClasses[\'form-file-name\'] %>"><strong>' +
((__t = (ctx.t('fileName'))) == null ? '' : __t) +
'</strong></div>\n        <div class="<%= cssClasses[\'form-file-size\'] %>"><strong>' +
((__t = (ctx.t('size'))) == null ? '' : __t) +
'</strong></div>\n        ';
 if (ctx.self.hasTypes) { ;
__p += '\n          <div class="<%= cssClasses[\'form-file-type\'] %>"><strong>' +
((__t = (ctx.t('type'))) == null ? '' : __t) +
'</strong></div>\n        ';
 } ;
__p += '\n        <div class="<%= cssClasses[\'form-file-actions\'] %>">\n          ';
 if (ctx.showSyncButton) { ;
__p += '\n            <button\n              class="<%= cssClasses[\'form-file-sync\'] %>"\n              ref="syncNow"\n              ';
...
__p += '\n      <li class="<%= cssClasses[\'form-file-item\'] %>">\n        <div class="<%= cssClasses[\'form-file-row\'] %>">\n          <div class="<%= cssClasses[\'form-file-name\'] %>">\n            ';
...
'" target="_blank" ref="fileLink" class="<%= cssClasses[\'form-file-link\'] %>">\n                <span class="<%= cssClasses[\'form-file-hidden\'] %>">' +
((__t = (ctx.t('pressToOpen') + ' ')) == null ? '' : __t) +
'</span>' +
((__t = (file.originalName || file.name)) == null ? '' : __t) +
'\n              </a>\n            ';
 } ;
__p += '\n          </div>\n          <div class="<%= cssClasses[\'form-file-size\'] %>">' +
((__t = (ctx.fileSize(file.size))) == null ? '' : __t) +
'</div>\n          ';
 if (ctx.self.hasTypes && !ctx.disabled) { ;
__p += '\n            <div class="<%= cssClasses[\'form-file-type\'] %>">\n              <select class="<%= cssClasses[\'form-file-type-select\'] %>" ref="fileType">\n                ';
...
__p += '\n          ';
 if (!ctx.disabled) { ;
__p += '\n            <div class="<%= cssClasses[\'form-file-actions\'] %>"><i tabindex="0" class="<%= cssClasses[\'form-file-remove\'] %> ' +
...
__p += '\n      <li class="<%= cssClasses[\'form-file-item\'] %>">\n        <div class="<%= cssClasses[\'form-file-row\'] %>">\n          <div class="<%= cssClasses[\'form-file-name\'] %>">\n            <div>' +
((__t = (file.originalName || file.name)) == null ? '' : __t) +
'</div>\n            <div class="<%= cssClasses[\'form-file-status\'] %> <%= cssClasses[\'form-file-status-\' + file.status] %>">' +
...
__p += '\n            <div class="<%= cssClasses[\'form-file-actions\'] %>"><i tabindex="0" class="<%= cssClasses[\'form-file-restore\'] %> ' +
...
__p += '\n              <div class="<%= cssClasses[\'form-file-progress\'] %>">\n                <div id="' +
((__t = (file.id)) == null ? '' : __t) +
'" class="<%= cssClasses[\'form-file-progress-bar\'] %>" role="progressbar" aria-valuenow="' +
...
__p += '\n          ';
 if (file.status === 'progress') { ;
__p += '\n            <div class="<%= cssClasses[\'form-file-actions\'] %>"><i id="abort-' +
((__t = (file.id)) == null ? '' : __t) +
'" tabindex="0" class="<%= cssClasses[\'form-file-abort\'] %> ' +
...
__p += '\n  <div class="<%= cssClasses[\'form-file-image-container\'] %>">\n    ';
 ctx.files.forEach(function(file) { ;
__p += '\n      <div class="<%= cssClasses[\'form-file-image-wrapper\'] %>">\n        <span class="<%= cssClasses[\'form-file-image\'] %>">\n          <img ref="fileImage" src="" alt="' +
((__t = (file.originalName || file.name)) == null ? '' : __t) +
'" style="width:' +
((__t = (ctx.component.imageSize)) == null ? '' : __t) +
'px">\n          ';
 if (!ctx.disabled) { ;
__p += '\n            <i tabindex="0" class="<%= cssClasses[\'form-file-remove\'] %> ' +
((__t = (ctx.iconClass('remove'))) == null ? '' : __t) +
...
__p += '\n    <div class="<%= cssClasses[\'form-file-selector\'] %>">\n      <button class="<%= cssClasses[\'form-file-gallery\'] %>" ref="galleryButton"><i class="' +
((__t = (ctx.iconClass('book'))) == null ? '' : __t) +
'"></i> ' +
((__t = (ctx.t('gallery'))) == null ? '' : __t) +
'</button>\n      <button class="<%= cssClasses[\'form-file-camera\'] %>" ref="cameraButton"><i class="' +
((__t = (ctx.iconClass('camera'))) == null ? '' : __t) +
'"></i> ' +
((__t = (ctx.t('camera'))) == null ? '' : __t) +
'</button>\n    </div>\n  ';
 } else if (!ctx.self.cameraMode) { ;
__p += '\n    <div class="<%= cssClasses[\'form-file-selector\'] %>" ref="fileDrop" ' +
...
__p += '\n        <a href="#" ref="toggleCameraMode" class="<%= cssClasses[\'form-file-camera-toggle\'] %>"><i class="' +
((__t = (ctx.iconClass('camera'))) == null ? '' : __t) +
'"></i>' +
...
__p += '\n      <a href="#" ref="fileBrowse" class="<%= cssClasses[\'form-file-browse\'] %>">\n        ';
...
'\n        </span>\n      </a>\n      <div ref="fileProcessingLoader" class="<%= cssClasses[\'form-file-loader-wrapper\'] %>">\n        <div class="<%= cssClasses[\'form-file-loader\'] %>"></div>\n      </div>\n    </div>\n  ';
 } else { ;
__p += '\n    <div class="<%= cssClasses[\'form-file-video-container\'] %>">\n      <video class="<%= cssClasses[\'form-file-video\'] %>" autoplay="true" ref="videoPlayer" tabindex="-1"></video>\n    </div>\n    <button class="<%= cssClasses[\'form-file-take-picture\'] %>" ref="takePictureButton"><i class="' +
((__t = (ctx.iconClass('camera'))) == null ? '' : __t) +
'"></i> ' +
((__t = (ctx.t('takePicture'))) == null ? '' : __t) +
'</button>\n    <button class="<%= cssClasses[\'form-file-camera-toggle\'] %>" ref="toggleCameraMode">' +
...
__p += '\n  <div class="<%= cssClasses[\'form-file-warning\'] %>">\n    ';
