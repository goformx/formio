...
__p += '\n  <ul class="divide-y divide-border rounded-lg border border-border">\n    <li class="px-4 py-3 font-semibold bg-muted/50 hidden-xs hidden-sm">\n      <div class="grid grid-cols-12 gap-4">\n        <div class="col-span-' +
...
__p += '\n            <button\n              class="inline-flex items-center justify-center gap-2 rounded-md bg-primary text-primary-foreground px-3 py-1.5 text-sm font-medium shadow-sm hover:bg-primary/90 transition-colors"\n              ref="syncNow"\n              ';
...
((__t = (file.status === 'error' ? 'destructive': file.status)) == null ? '' : __t) +
'">' +
...
__p += '\n              <div class="status h-2 w-full overflow-hidden rounded-full bg-muted">\n                <div id="' +
((__t = (file.id)) == null ? '' : __t) +
'" class="h-full bg-primary transition-all" role="progressbar" aria-valuenow="' +
...
__p += '\n    <div class="fileSelector">\n      <button class="inline-flex items-center justify-center gap-2 rounded-md bg-primary text-primary-foreground px-4 py-2 text-sm font-medium shadow-sm hover:bg-primary/90 transition-colors" ref="galleryButton"><i class="' +
((__t = (ctx.iconClass('book'))) == null ? '' : __t) +
'"></i> ' +
((__t = (ctx.t('gallery'))) == null ? '' : __t) +
'</button>\n      <button class="inline-flex items-center justify-center gap-2 rounded-md bg-primary text-primary-foreground px-4 py-2 text-sm font-medium shadow-sm hover:bg-primary/90 transition-colors" ref="cameraButton"><i class="' +
...
__p += '\n    <div class="video-container">\n      <video class="video" autoplay="true" ref="videoPlayer" tabindex="-1"></video>\n    </div>\n    <button class="inline-flex items-center justify-center gap-2 rounded-md bg-primary text-primary-foreground px-4 py-2 text-sm font-medium shadow-sm hover:bg-primary/90 transition-colors" ref="takePictureButton"><i class="' +
((__t = (ctx.iconClass('camera'))) == null ? '' : __t) +
'"></i> ' +
((__t = (ctx.t('takePicture'))) == null ? '' : __t) +
'</button>\n    <button class="inline-flex items-center justify-center gap-2 rounded-md bg-primary text-primary-foreground px-4 py-2 text-sm font-medium shadow-sm hover:bg-primary/90 transition-colors" ref="toggleCameraMode">' +
...
__p += '\n  <div class="rounded-md border border-yellow-500/50 bg-yellow-500/10 px-4 py-3 text-sm text-yellow-700 dark:text-yellow-400">\n    ';
