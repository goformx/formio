...
'\n<div\n  class="' +
((__t = ( cssClasses['form-signature'] )) == null ? '' : __t) +
'"\n  data-width="' +
...
'"\n  ref="padBody"\n>\n  <a class="' +
((__t = ( cssClasses['form-signature-refresh'] )) == null ? '' : __t) +
'" ref="refresh">\n    <i class="' +
((__t = (ctx.iconClass('refresh'))) == null ? '' : __t) +
'"></i>\n  </a>\n  <canvas class="' +
((__t = ( cssClasses['form-signature-canvas'] )) == null ? '' : __t) +
'" data-height="' +
((__t = (ctx.component.height)) == null ? '' : __t) +
'" ref="canvas"></canvas>\n  ';
 if (ctx.required) { ;
__p += '\n  <span class="' +
((__t = ( cssClasses['form-signature-required'] )) == null ? '' : __t) +
'">\n    <i class="' +
((__t = (ctx.iconClass('asterisk'))) == null ? '' : __t) +
'"></i>\n  </span>\n  ';
 } ;
__p += '\n  <img class="' +
((__t = ( cssClasses['form-signature-image'] )) == null ? '' : __t) +
'" ref="signatureImage">\n</div>\n';
 if (ctx.component.footer) { ;
__p += '\n  <div class="' +
((__t = ( cssClasses['form-signature-footer'] )) == null ? '' : __t) +
'">\n    ' +
