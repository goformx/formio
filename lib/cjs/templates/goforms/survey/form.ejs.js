...
__p += '<table class="w-full text-sm [&_tbody_tr:nth-child(odd)]:bg-muted/50 border border-border [&_th]:border [&_th]:border-border [&_td]:border [&_td]:border-border" aria-labelledby="l-' +
