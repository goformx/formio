...
__p += '<table class="w-full text-sm [&_tbody_tr:nth-child(odd)]:bg-muted/50 [&_th]:border [&_th]:border-border [&_td]:border [&_td]:border-border [&_th]:px-4 [&_th]:py-2 [&_td]:px-4 [&_td]:py-2">\n  <tbody>\n    ';
