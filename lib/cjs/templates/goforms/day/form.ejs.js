...
__p += '<div class="grid grid-cols-12 gap-4" role="group"\n  ';
...
__p += 'after:content-[\'*\'] after:ml-0.5 after:text-destructive';
 } ;
__p += '">' +
...
__p += '\n</div>\n<input name="ctx.data[day]" type="hidden" lang="en" value="" ref="input">\n';
return __p
}