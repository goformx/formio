...
__p += '\n    </ul>\n  </div>\n  ';
 ctx.component.components.forEach(function(tab, index) { ;
__p += '\n  <div\n    role="tabpanel"\n    class="' +
((__t = ( ctx.cssClasses['form-tab-panel'] )) == null ? '' : __t) +
'"\n    style="display: ' +
