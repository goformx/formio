...
((__t = ( cssClasses['form-fieldset'] )) == null ? '' : __t) +
'">\n  ';
 if (ctx.component.legend) { ;
__p += '\n  <legend ref="header" class="' +
((__t = ( cssClasses['form-fieldset-legend'] )) == null ? '' : __t) +
' ' +
...
((__t = ( cssClasses['form-fieldset-tooltip'] )) == null ? '' : __t) +
' ' +
...
__p += '\n  ';
 if (!ctx.collapsed) { ;
__p += '\n  <div class="' +
((__t = ( cssClasses['form-fieldset-body'] )) == null ? '' : __t) +
'" ref="' +
