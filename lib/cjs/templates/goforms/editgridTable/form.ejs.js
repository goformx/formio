...
((__t = ( cssClasses['form-editgrid-table-container'] )) == null ? '' : __t) +
'">\n  <div class="' +
((__t = ( cssClasses['form-editgrid-table-responsive'] )) == null ? '' : __t) +
'">\n    <table class="' +
((__t = ( cssClasses['form-editgrid-table'] )) == null ? '' : __t) +
'\n      ' +
...
'\n    ">\n      ';
 if (ctx.header) { ;
__p += '\n      <thead class="' +
((__t = ( cssClasses['form-editgrid-table-head'] )) == null ? '' : __t) +
'">\n        ' +
((__t = (ctx.header)) == null ? '' : __t) +
'\n      </thead>\n      ';
 } ;
__p += '\n      <tbody class="' +
((__t = ( cssClasses['form-editgrid-table-body'] )) == null ? '' : __t) +
'">\n        ';
...
__p += '\n            <td class="' +
((__t = ( cssClasses['form-editgrid-table-column'] )) == null ? '' : __t) +
'">\n              <div class="' +
((__t = ( cssClasses['form-editgrid-table-actions'] )) == null ? '' : __t) +
'">\n                <button class="' +
((__t = ( cssClasses['form-editgrid-table-save'] )) == null ? '' : __t) +
'" ref="' +
...
__p += '\n                <button class="' +
((__t = ( cssClasses['form-editgrid-table-cancel'] )) == null ? '' : __t) +
'" ref="' +
...
((__t = ( cssClasses['form-editgrid-table-column'] )) == null ? '' : __t) +
'">\n            <div class="' +
((__t = ( cssClasses['form-editgrid-table-error-container'] )) == null ? '' : __t) +
'">\n              <div class="' +
((__t = ( cssClasses['form-editgrid-table-error'] )) == null ? '' : __t) +
'">\n                ' +
...
__p += '\n<button class="' +
((__t = ( cssClasses['form-editgrid-table-add'] )) == null ? '' : __t) +
'" ref="' +
